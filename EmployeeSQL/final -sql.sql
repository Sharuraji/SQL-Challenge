...
ALTER TABLE "titles" ADD CONSTRAINT "pk_title_id" PRIMARY KEY("title_id");

ALTER TABLE "dept_emp" ADD CONSTRAINT "pkcomposite_emp_no_dept_no" PRIMARY KEY ("emp_no","dept_no");
...
SELECT first_name,last_name,hire_date,EXTRACT (YEAR FROM(TO_DATE(hire_date,'MM/DD/YYYY'))) FROM employees
...
SELECT COUNT(last_name ) ln_count,last_name
FROM employees
GROUP BY last_name
